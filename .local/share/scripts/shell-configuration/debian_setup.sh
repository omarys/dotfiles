...
sudo nala install build-essential opensc libpcsc-perl libpcsclite-dev \
	...
	libfontconfig1-dev libxcb-xfixes0-dev libxkbcommon-dev python3 tmux aspell \
	aspell-en xclip ninja-build gettext cmake unzip curl libssl-dev stow git \
	zsh autoconf texinfo libx11-dev libmagickwand-dev libxaw7-dev \
	libgccjit-12-dev libgif-dev libjansson4 libjansson-dev gnutls-bin \
	...
	gnuplot editorconfig npm nodejs default-jdk glslang-dev glslang-tools \
	...
	plasma-discover-backend-flatpak libnss3-tools syncthingtray-kde-plasma \
	flatpak procps
...
unzip CascadiaCode.zip -d ~/.local/share/fonts/ # a reboot will install these
