...
(doom! :input
       ...
       (treemacs +lsp +unicode)          ; a project drawer, like neotree but cooler
       ...
       (editorconfig +folding)       ; let someone else argue about tabs vs spaces
       ...
       (org +roam +journal +pretty +pandoc +present)               ; organize your plain life in plain text
       ;;php               ; perl's insecure younger brother
       ;;plantuml          ; diagrams for confusing people more
       ;;graphviz          ; diagrams for confusing yourself even more
       ;;purescript        ; javascript, but functional
       (python +lsp +ruff +tree-sitter +uv)            ; beautiful is better than ugly
