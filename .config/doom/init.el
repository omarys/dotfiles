...
(doom! :input
       ...
       (spell +aspell) ; tasing you for misspelling misspelling
       ...
       (org +roam +journal +pretty +gnuplot +jupyter +pandoc +noter +hugo +present +pomodoro)               ; organize your plain life in plain text
       ...
       ;;rst               ; ReST in peace
       ;; (ruby +lsp +rails +rbenv +rvm)     ; 1.step {|i| p "Ruby is #{i.even? ? 'love' : 'life'}"}
