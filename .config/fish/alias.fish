...
alias xp="xplr"
alias neovimup="fish ~/.config/fish/functions/nvim_update.fish"
alias cclsup="fish ~/.config/fish/functions/ccls_update.fish"
alias rustanalup="fish ~/.config/fish/functions/rust-analyzer_build.fish"
